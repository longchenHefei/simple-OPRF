        ...
        int128 delta, OT_ROLE role, bool passive)
{
    ...
    printf("Do not use OTE!!!!!!!!!!!!!\n");
    PRNG G;

    // printf("Setup!!!!!!!!!!!!!\n");
    //     if (role & SENDER)
    // {
    //     printf("Hi. This is a SENDER.\n");
    // }


    // if (role & RECEIVER)
    // {
    //     printf("Hi. This is a RECEIVER.\n");
    // }
    ...
    //  printf("BaseOT is done. OTE begins.\n");
...
void OTExtensionWithMatrix::soft_sender(size_t n)
{
    ...
    if (ot_role & SENDER)
    {
        printf("Hi. This is a Extension_SENDER.\n");
    }


    if (ot_role & RECEIVER)
    {
        printf("Hi. This is a Extension_RECEIVER.\n");
    }
