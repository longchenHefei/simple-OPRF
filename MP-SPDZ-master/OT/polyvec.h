...
extern void polyvec_pointwise_acc_k2(poly *r, const polyvec *a, const polyvec *b);
extern void polyvec_pointwise_acc_k3(poly *r, const polyvec *a, const polyvec *b);
extern void polyvec_pointwise_acc_k4(poly *r, const polyvec *a, const polyvec *b);
